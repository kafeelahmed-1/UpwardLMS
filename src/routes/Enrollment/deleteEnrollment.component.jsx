...
const DeleteEnrollment = ({closeModal , onDelSuccess , refreshData}) => {
    ...
    const handleDelEnrollment =  () => {

      // console.log("on del course");
      const token = localStorage.getItem("token");

      fetch(`${process.env.REACT_APP_BASE_URL}/api/StudentEnrollment/${deleteId}`, {
        method: "DELETE",
        headers: {
    ...
    return(
      <>
         <div className="border border-secondary w-[520px] min-h-[252px] h-[fit-content] rounded-lg mx-auto bg-white">
          {/* div 1 : FORM TITLE*/}
          <FormTitle title="Delete Enrollment?" formClosed={onClose}/>
