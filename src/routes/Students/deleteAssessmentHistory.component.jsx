...
const DeleteHistory = ({closeModal , onDelSuccess , refreshData}) => {
    

    refreshData();
    const {delHistoryId} = useParams();
    ...
    const handleDelHistory =  () => {
      ...
      fetch(`${process.env.REACT_APP_BASE_URL}/api/AssessmentScoreHead/${delHistoryId}`, {
        method: "DELETE",
        headers: {
    ...
    return(
        <>
         ...
         <div className="border border-secondary w-[520px] min-h-[252px] h-[fit-content] rounded-lg mx-auto bg-white">
          {/* div 1 : FORM TITLE*/}
          <FormTitle title="Delete Assessment  History?" formClosed={onClose}/>
